        ...
        <div class="col-md-4">
            <main class="form-signin w-100 m-auto">
                <form action="/register" method="post">
                    @csrf
                    <h1 class="h3 mb-3 fw-normal mt-3">Registration Form</h1>

                    <div class="form-floating">
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="nama" autofocus>
                    ...
                    <p class="text-center mt-3">Login Khusus Admin <a href="/login" class="text-decoration-none">Login</a></p>
